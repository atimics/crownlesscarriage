...
blender-hero-assets:
	$(BLENDER) --background --factory-startup --python tools/blender/build_hero_component_library.py
	python3 tools/blender/compose_hero_preview.py

blender-hero-assets-check:
	$(BLENDER) --background assets/blender/crownless_hero_components.blend --python tools/blender/validate_hero_component_library.py

blender-hero-animation:
	$(BLENDER) --background assets/blender/crownless_hero_components.blend --python tools/blender/render_hero_animation.py
	python3 tools/blender/encode_hero_animation.py

blender-hero-actions:
	$(BLENDER) --background assets/blender/crownless_hero_components.blend --python tools/blender/render_hero_actions.py
