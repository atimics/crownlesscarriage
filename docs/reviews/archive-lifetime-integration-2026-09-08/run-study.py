...
binaries={'parent':'/private/tmp/archive-integrate-parent-probe','repair':'/private/tmp/archive-integrate-fixed-probe'}
jobs=[(arm,n,y,0) for arm in binaries for n,y in cases]
jobs += [(arm,n,1000,0) for arm in ('parent','repair') for n in range(1,33)]
def run(job):
 arm,n,y,schema=job
