...
| ash / ashes | zhur / zhuruk | cooled dragon fire, counted by `-uk` |
| lair / cave | nukh / grak'nukh | a clan hollow / a stone hollow |
| shrine | zhur'nukh | an ash hollow kept for ritual |
...
waits.” becomes “Ashkeepers seal tak zhur-vault while tak nukh waits.” A shrine
is a `zhur'nukh`, an ash hollow; a clutch is `kesh'khor`, eggs held as clan kin;
