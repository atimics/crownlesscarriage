...
The fixture databases use SQLite DELETE journal mode so each saved file contains its complete state. The naming fixture retains the application journal rows inside the database.
