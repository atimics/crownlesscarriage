...
/* Schemas 75-95 shipped ahead of this branch; the notice board
   region is schema 96. */
/* Schema at which a posted notice stops displacing word of mouth. */
#define CC_NOTICE_BOARD_SCHEMA 96U
/* Slots [0, CC_NOTICE_BOARD_SLOTS) hold posted notices; the rest are
   word of mouth. */
...
typedef enum CcEventKind {
    ...
    CC_EVENT_SHORTAGE = 2,
    CC_EVENT_SHIPMENT_DEPARTED = 3,
    CC_EVENT_SHIPMENT_ARRIVED = 4,
    CC_EVENT_BANDIT_PRESSURE = 5,
    CC_EVENT_MONSTER_PRESSURE = 6,
    CC_EVENT_PLAYER_TRADE = 7,
    CC_EVENT_PLAYER_TRAVEL = 8,
    CC_EVENT_ROUTE_REPAIRED = 9,
    CC_EVENT_DUNGEON_CHANGED = 10,
    CC_EVENT_RELIEF = 11,
    CC_EVENT_SHIPMENT_LOST = 12,
    CC_EVENT_KINGDOM_ACTION = 13,
    CC_EVENT_ROUTE_DECAY = 14,
    CC_EVENT_FACTION_SHIFT = 15,
    CC_EVENT_SITUATION_CREATED = 16,
    CC_EVENT_SITUATION_RESOLVED = 17,
    CC_EVENT_SITUATION_FAILED = 18,
    CC_EVENT_PLAYER_AMBUSH = 19,
    CC_EVENT_MAP_BOUGHT = 20,
    CC_EVENT_MAP_SOLD = 21,
    CC_EVENT_CHARTER_ACCEPTED = 22,
    CC_EVENT_CHARTER_ABANDONED = 23,
    CC_EVENT_JOURNEY_ENCOUNTER = 24,
    CC_EVENT_ENCOUNTER_COMBAT = 25,
    CC_EVENT_ENCOUNTER_NEGOTIATED = 26,
    CC_EVENT_DELAYED_ECHO = 27,
    CC_EVENT_JOURNEY_DEPARTED = 28,
    CC_EVENT_SERVICE_OPENED = 29,
    CC_EVENT_BANDIT_RAID_DEPARTED = 30,
    CC_EVENT_SETTLEMENT_RAIDED = 31,
    CC_EVENT_BANDIT_RAID_RETURNED = 32,
    CC_EVENT_GOBLIN_TRIBUTE_DEPARTED = 33,
    CC_EVENT_GOBLIN_TRIBUTE_TAKEN = 34,
    CC_EVENT_GOBLIN_TRIBUTE_DELIVERED = 35,
    CC_EVENT_DRAGON_HOARD_STOLEN = 36,
    CC_EVENT_DRAGON_OMEN = 37,
    CC_EVENT_DRAGON_TREASURE_RETURNED = 38,
    CC_EVENT_DRAGON_RETALIATION = 39,
    CC_EVENT_INEQUALITY_PRESSURE = 40,
    CC_EVENT_HOARD_HEIST_DEPARTED = 41,
    CC_EVENT_HOARD_HEIST_RETURNED = 42,
    CC_EVENT_WAR_PRESSURE = 43,
    CC_EVENT_WAR_CHEST_FUNDED = 44,
    CC_EVENT_WAR_SUPPLY_BOUGHT = 45,
    CC_EVENT_WAR_SUPPLY_SHORTAGE = 46,
    CC_EVENT_RESOURCE_EXTRACTED = 47,
    CC_EVENT_SMITH_PRODUCTION = 48,
    CC_EVENT_TREASURE_CRAFTED = 49,
    CC_EVENT_GOBLIN_RAID_DEPARTED = 50,
    CC_EVENT_GOBLIN_RAIDED = 51,
    CC_EVENT_GOBLIN_RAID_RETURNED = 52,
    CC_EVENT_WAR_MATERIEL_LOST = 53,
    CC_EVENT_IRON_LEDGER_LOAN = 54,
    CC_EVENT_IRON_LEDGER_REPAID = 55,
    CC_EVENT_GOBLIN_HOARD_DEFENDED = 56,
    CC_EVENT_COURIER_DEPARTED = 57,
    CC_EVENT_COURIER_ARRIVED = 58,
    CC_EVENT_COURIER_LOST = 59,
    CC_EVENT_COURIER_DISTORTED = 60,
    CC_EVENT_WAR_DECLARED = 61,
    CC_EVENT_PEACE_DECLARED = 62,
    CC_EVENT_ALLIANCE_DECLARED = 63,
    CC_EVENT_DRAGON_MUSTERED = 64,
    CC_EVENT_DRAGON_BATTLE = 65,
    CC_EVENT_DRAGON_SLAIN = 66,
    CC_EVENT_DRAGON_HOARD_RECOVERED = 67,
    CC_EVENT_DRAGON_HUNT = 68,
    CC_EVENT_DRAGON_CROWNED = 69,
    CC_EVENT_DRAGON_UNCROWNED = 70,
    CC_EVENT_DRAGON_BROOD = 71,
    CC_EVENT_DRAGON_WHELP_DISPERSED = 72,
    CC_EVENT_DRAGON_AFTERSHOCK = 73,
    CC_EVENT_DRAGON_SUCCESSOR = 74,
    CC_EVENT_GOBLIN_CULT_RALLIED = 75,
    CC_EVENT_GOBLIN_DRAGON_SEED = 76,
    CC_EVENT_ENCOUNTER_WITHDRAWN = 77,
    CC_EVENT_COW_CALVING = 78,
    CC_EVENT_COW_SLAUGHTERED = 79,
    CC_EVENT_HORSE_BRED = 80,
    CC_EVENT_FOAL_BORN = 81,
    CC_EVENT_HORSE_TEAM_CHANGED = 82,
    CC_EVENT_GOBLIN_RAID_PREPARED = 83,
    CC_EVENT_GOBLIN_TARGET_WARNED = 84,
    CC_EVENT_GOBLIN_EXPEDITION_INTERCEPTED = 85,
    CC_EVENT_GOBLIN_TRADE = 86,
    CC_EVENT_GOBLIN_DRAGON_SEED_RUMORED = 87,
    CC_EVENT_GOBLIN_DRAGON_SEED_PREPARED = 88,
    CC_EVENT_CHARACTER_INTERACTION = 89,
    CC_EVENT_JOURNEY_WARNING = 90,
    CC_EVENT_AMBUSH_EVADED = 91,
    CC_EVENT_ENCOUNTER_LOOT = 92,
    CC_EVENT_GOBLIN_TUNNEL_TRAVERSED = 93,
    CC_EVENT_DUNGEON_EXPEDITION_BEGAN = 94,
    CC_EVENT_DUNGEON_ROOM_ENTERED = 95,
    CC_EVENT_DUNGEON_ENCOUNTER = 96,
    CC_EVENT_DUNGEON_SHORTCUT_OPENED = 97,
    CC_EVENT_DUNGEON_LOOT = 98,
    CC_EVENT_DUNGEON_THRESHOLD_REACHED = 99,
    CC_EVENT_DUNGEON_EXPEDITION_ENDED = 100,
    CC_EVENT_RELATIONSHIP_HISTORY = 101,
    CC_EVENT_RUMOR_SHARED = 102,
    CC_EVENT_FACT_REVEALED = 103,
    CC_EVENT_RELATIONSHIP_CHANGED = 104,
    CC_EVENT_FRONT_CREATED = 105,
    CC_EVENT_FRONT_RESOLVED = 106,
...
typedef enum CcCommandKind {
    ...
    CC_COMMAND_TRADE = 1,
    CC_COMMAND_TRAVEL = 2,
    CC_COMMAND_REPAIR_ROUTE = 3,
    CC_COMMAND_CHANGE_DUNGEON = 4,
    CC_COMMAND_BUY_MAP = 5,
    CC_COMMAND_SELL_MAP = 6,
    CC_COMMAND_ACCEPT_SITUATION = 7,
    CC_COMMAND_ABANDON_SITUATION = 8,
    CC_COMMAND_RESOLVE_ENCOUNTER_COMBAT = 9,
    CC_COMMAND_RESOLVE_ENCOUNTER_NEGOTIATE = 10,
    CC_COMMAND_REFUSE_SITUATION = 11,
    CC_COMMAND_STEAL_DRAGON_HOARD = 12,
    CC_COMMAND_RETURN_DRAGON_TREASURE = 13,
    CC_COMMAND_BUY_TREASURE = 14,
    CC_COMMAND_SELL_TREASURE = 15,
    CC_COMMAND_ARCHIVE_MAP = 16,
    CC_COMMAND_RETRIEVE_MAP = 17,
    CC_COMMAND_STEAL_DRAGON_NAMED_TREASURE = 18,
    CC_COMMAND_RETURN_DRAGON_NAMED_TREASURE = 19,
    CC_COMMAND_RESOLVE_ENCOUNTER_PROVISIONS = 20,
    CC_COMMAND_WITHDRAW_ENCOUNTER = 21,
    CC_COMMAND_BREED_HORSES = 22,
    CC_COMMAND_ASSIGN_HORSE = 23,
    CC_COMMAND_INTERCEPT_DRAGON_TRIBUTE = 24,
    CC_COMMAND_GOBLIN_TRADE = 25,
    CC_COMMAND_GOBLIN_WARN = 26,
    CC_COMMAND_GOBLIN_INTERCEPT = 27,
    CC_COMMAND_CHARACTER_RESPONSE = 28,
    CC_COMMAND_SET_JOURNEY_PACE = 29,
    CC_COMMAND_TRAVERSE_GOBLIN_TUNNEL = 30,
    CC_COMMAND_BEGIN_DUNGEON_EXPEDITION = 31,
    CC_COMMAND_MOVE_DUNGEON = 32,
...
typedef struct CcRouteKnowledge {
    CcId route_id;
...
typedef struct CcDragon {
    ...
    bool slain;
    int32_t slain_day;
    /* Cumulative dragons slain in this world; successor hatchings keep
       counting. Unlike the end-state slain flag this never resets. */
    int32_t dragons_slain;
...
_Static_assert(sizeof(CcSim) == 509744,
