...
#define GetMousePosition() ClientPointerPosition()
                                  ...
                                  int32_t selected_situation)
{
    ...
    for (int32_t i = first; i < first + shown; ++i) {
        ...
        if (action->detail[0] != '\0') {
            int detail_size = local->adventure_ui ? 11 : 7;
            char detail[48];
