...
static const CcLocalPlaceProfile PLACE_PROFILES[] = {
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "RIVER CROSSING",
             82.00f, 34.00f, 80.00f, 3.80f, 29.00f,
             16.00f, 3.10f, 6.00f, 16.50f},
            {CC_LOCAL_TOWN_SCENE_HEART, "THRESHING GREEN",
             44.00f, 29.00f, 47.00f, 3.20f, 27.00f,
             -5.00f, 2.90f, 20.00f, 12.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "GRANARY RISE",
             78.00f, 27.00f, 76.00f, 3.50f, 23.00f,
             6.00f, 3.00f, 13.00f, 13.50f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "DROVERS' CLOSE",
             32.00f, 38.00f, 30.00f, 2.80f, 39.00f,
             5.00f, 2.70f, 13.00f, 9.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "MILLER'S BEND",
             58.00f, 50.00f, 60.50f, 2.80f, 50.00f,
             6.00f, 2.70f, 12.00f, 9.00f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "CARTWRIGHT YARD",
             42.40f, 55.20f, 40.50f, 2.80f, 53.00f,
    ...
    },
    {
        ...
        .lane = {
            ...
            {"Butchers' terrace", 2.8f, 5, {{76,53}, {80,53},
                {80,64}, {80,68.5f}, {74,68.5f}}},
            {"Mine supply walk", 2.2f, 4, {{32,54}, {28,57},
                {24,58.05f}, {21.6f,58.05f}}},
        },
        .carriage_lane_count = 3,
        .carriage_lane = {{0,8}, {1,4}, {8,2}},
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "FOUNDRY TERRACE",
             82.00f, 34.00f, 78.00f, 3.80f, 30.00f,
             16.00f, 3.00f, 6.00f, 15.50f},
            {CC_LOCAL_TOWN_SCENE_HEART, "COMPANY STORE",
             44.00f, 29.00f, 49.00f, 3.30f, 28.00f,
             -6.00f, 2.90f, 18.00f, 12.50f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "LOWER SILVERWORKS",
             78.00f, 29.00f, 78.00f, 4.00f, 25.00f,
             10.00f, 3.00f, 18.00f, 15.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "WORKERS' LANE",
             33.00f, 25.00f, 31.00f, 3.00f, 24.80f,
             9.00f, 2.80f, 7.20f, 10.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "FURNACE ALLEY",
             27.00f, 50.00f, 25.00f, 2.80f, 48.00f,
             9.00f, 2.70f, 9.00f, 9.00f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "ORE WAGON YARD",
             42.40f, 55.20f, 39.50f, 2.80f, 52.00f,
             -10.00f, 2.80f, 10.00f, 10.50f},
        },
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "CUSTOMS ARCH",
             82.00f, 34.00f, 78.00f, 3.50f, 34.00f,
             15.00f, 3.00f, 12.00f, 14.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "MARKET CIRCLE",
             44.00f, 29.00f, 46.00f, 3.70f, 31.00f,
             14.00f, 3.10f, 14.00f, 14.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "ARCHIVE STEPS",
             39.50f, 23.00f, 35.00f, 3.50f, 21.00f,
             9.00f, 2.90f, 15.00f, 11.50f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "CLOTH YARD",
             24.00f, 28.00f, 24.00f, 3.00f, 25.00f,
             11.00f, 2.80f, 7.00f, 10.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "EXCHANGE DOOR",
             50.00f, 27.25f, 49.50f, 3.10f, 25.00f,
             -7.00f, 2.90f, 13.00f, 10.00f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "COACH COURT",
             42.40f, 55.20f, 38.00f, 2.80f, 54.00f,
             2.00f, 2.80f, 16.00f, 11.50f},
        },
    ...
    },
    {
        ...
        .lane_count = 11,
        .lane = {
            {"Bridge inspection", 5.4f, 9, {{96,36}, {90,36}, {84,35.5f},
                {78,35.5f}, {70,35.5f}, {62,35}, {55,34}, {48,33}, {42,32}}},
            {"Muster street", 5.0f, 6, {{42,32}, {42,37}, {42,42},
                {42,47}, {42,51.2f}, {42.4f,55.2f}}},
            {"Lower bailey turn", 3.4f, 3, {{42,51.2f}, {40,51.4f},
                {37.4f,51.2f}}},
            {"Armourers' row", 3.2f, 6, {{42,32}, {36,29}, {29,29},
                {22,29}, {16,29}, {11,29}}},
            {"Quartermaster walk", 3.2f, 5, {{42,32}, {41.5f,27.5f},
                {41.5f,24.5f}, {41.5f,18}, {41.5f,10}}},
            {"Supply yard", 3.4f, 6, {{42,47}, {49,52}, {56,52},
                {64,53}, {72,54}, {78,53}}},
            {"Drill yard path", 2.2f, 5, {{42,47}, {36,47}, {30,47},
                {25,48}, {18,50}}},
            {"Alder gate pass", 3.0f, 4, {{78,35.5f}, {78.5f,33},
                {78.5f,31}, {78.5f,28}}},
            {"Arsenal approach", 2.2f, 4, {{55,34}, {56,38},
                {60,39}, {65,39}}},
            {"March stores walk", 2.2f, 4, {{56,52}, {64,54},
                {65,67.8f}, {55,67.8f}}},
            {"Bakehouse approach", 2.4f, 5, {{72,54}, {82,54},
                {82,63}, {82,67.5f}, {76,67.5f}}},
        },
        .carriage_lane_count = 3,
        .carriage_lane = {{0,8}, {1,4}, {2,2}},
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "CONTESTED BRIDGE",
             82.00f, 34.00f, 87.00f, 3.40f, 33.50f,
             -9.00f, 3.20f, 7.50f, 16.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "MUSTER SPINE",
             44.00f, 29.00f, 47.00f, 3.50f, 29.00f,
             6.00f, 3.00f, 10.00f, 12.50f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "ALDERWATCH KEEP",
             78.50f, 27.00f, 78.00f, 5.00f, 26.00f,
             3.00f, 3.00f, 21.00f, 18.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "ARMOURERS' ROW",
             33.00f, 25.00f, 34.00f, 3.00f, 26.00f,
             8.00f, 2.40f, 12.00f, 10.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "ALDER GATE PASS",
             73.50f, 32.50f, 78.50f, 3.80f, 29.50f,
             2.00f, 2.90f, 14.00f, 12.00f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "LOWER BAILEY",
             42.40f, 55.20f, 39.50f, 2.80f, 52.00f,
             7.00f, 2.90f, 16.00f, 11.00f},
        },
    ...
    },
    {
        ...
        .lane_count = 11,
        .lane = {
            {"Rose avenue", 5.4f, 9, {{96,36}, {90,36}, {84,37},
                {77,39}, {70,40}, {63,39}, {56,36}, {49,32}, {42,31}}},
            {"Petition approach", 5.0f, 6, {{42,31}, {44,37}, {47,43},
                {46,48}, {42,51.2f}, {42.4f,55.2f}}},
            {"Royal coach court", 3.4f, 3, {{42,51.2f}, {40,51.4f},
                {37.4f,51.2f}}},
            {"Exchange terrace", 3.2f, 5, {{42,31}, {42,27},
                {42,22}, {42,14}, {42,9}}},
            {"Guild street", 3.8f, 6, {{42,31}, {35,29}, {29,28.5f},
                {22,29}, {16,30}, {11,31}}},
            {"Palace petition walk", 2.8f, 6, {{56,36}, {62,34},
                {68,34}, {73,34}, {78.5f,33}, {78.5f,29}}},
            {"Rose cloister", 3.2f, 5, {{47,43}, {54,53}, {61,54},
                {69,54}, {77,53}}},
            {"East gardens", 2.4f, 4, {{70,40}, {75,45},
                {78,50}, {77,53}}},
            {"Scribes' frontage", 2.2f, 4, {{54,53}, {64,54},
                {65,67.8f}, {55,67.8f}}},
            {"Butchers' court", 2.4f, 5, {{69,54}, {79,54},
                {79,63}, {79,67.5f}, {72,67.5f}}},
            {"Rose ward walk", 2.0f, 3, {{79,67.5f}, {84,66},
                {86,65}}},
        },
        .carriage_lane_count = 3,
        .carriage_lane = {{0,8}, {1,4}, {2,2}},
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "ROSE AVENUE",
             82.0f, 34.0f, 81.00f, 4.50f, 34.00f,
             -10.00f, 3.10f, 19.00f, 16.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "PETITION SQUARE",
             44.0f, 29.0f, 46.00f, 3.50f, 29.00f,
             9.00f, 2.90f, 17.00f, 13.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "CROWN PALACE",
             78.0f, 19.0f, 78.00f, 5.00f, 20.00f,
             -11.00f, 3.20f, 22.00f, 19.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "GOLDSMITH COURT",
             33.0f, 25.0f, 36.00f, 3.00f, 24.50f,
             -7.00f, 2.80f, 14.00f, 10.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "ROSE CLOISTER",
             58.0f, 50.0f, 64.00f, 3.00f, 47.00f,
             8.00f, 2.80f, 12.00f, 10.00f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "ROYAL COACH YARD",
             42.4f, 55.2f, 39.50f, 2.80f, 52.00f,
             -9.00f, 2.90f, 13.00f, 10.50f},
        },
    ...
    },
    {
        ...
        .lane_count = 10,
        .lane = {
            {"Lantern road", 5.2f, 9, {{96,36}, {90,36}, {84,37},
                {78,39}, {71,41}, {64,40}, {57,37}, {49,33}, {42,31}}},
            {"Expedition hollow", 4.8f, 6, {{42,31}, {41,37},
                {42,43}, {42,47}, {42,51.2f}, {42.4f,55.2f}}},
            {"Wagon turning", 3.4f, 3, {{42,51.2f}, {40,51.4f},
                {37.4f,51.2f}}},
            {"Lantern crescent", 3.2f, 11, {{42,31}, {36,28}, {28,28},
                {20,28}, {12,31}, {10,38}, {11,46}, {10,55},
                {12,63}, {12,65.5f}, {17.5f,65.5f}}},
            {"Salvage crescent", 3.2f, 8, {{42,31}, {47,33},
                {52,34}, {58,35}, {64,37}, {70,38}, {78,39}, {84,37}}},
            {"Return inn approach", 3.2f, 9, {{39,44}, {44,49},
                {50,52}, {58,52}, {61,54}, {64,55}, {64,63},
                {82,63}, {72,62}}},
            {"Supply house walk", 3.2f, 5, {{42,31}, {41,27},
                {41,23}, {41,17}, {41,10}}},
            {"Warden lane", 2.2f, 6, {{42,51.2f}, {42,56},
                {40,58}, {32,58}, {25,57}, {18,56}}},
            {"Sealed gate road", 2.8f, 4, {{78,39}, {78,34},
                {78.5f,31}, {78.5f,28}}},
            {"Timber yard walk", 2.0f, 3, {{82,63}, {84,63.5f},
                {86,63.5f}}},
        },
        .carriage_lane_count = 3,
        .carriage_lane = {{0,8}, {1,4}, {2,2}},
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "LANTERN ROAD",
             82.0f, 34.0f, 81.00f, 3.60f, 34.00f,
             -10.00f, 2.90f, 17.00f, 14.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "EXPEDITION HOLLOW",
             44.0f, 29.0f, 46.00f, 3.00f, 30.00f,
             8.00f, 2.80f, 16.00f, 12.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "SEALED DUNGEON ROAD",
             78.0f, 19.0f, 79.00f, 4.00f, 20.00f,
             -10.00f, 3.00f, 20.00f, 17.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "SALVAGE ROW",
             34.0f, 38.0f, 33.00f, 2.80f, 38.50f,
             7.00f, 2.70f, 12.00f, 9.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "LANTERN GATE",
             29.0f, 51.8f, 28.50f, 2.80f, 49.50f,
             -7.00f, 2.70f, 12.00f, 9.00f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "EXPEDITION WAGON YARD",
             42.4f, 55.2f, 39.50f, 2.80f, 52.00f,
             -9.00f, 2.80f, 13.00f, 10.50f},
        },
