...
static const CcLocalPlaceProfile PLACE_PROFILES[] = {
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "RIVER CROSSING",
             82.00f, 34.00f, 80.00f, 0.16f, 29.00f,
             -18.00f, 0.64f, 28.00f, 28.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "THRESHING GREEN",
             44.00f, 29.00f, 45.00f, 0.14f, 25.00f,
             -15.00f, 0.64f, 23.00f, 20.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "GRANARY RISE",
             78.00f, 27.00f, 77.00f, 0.16f, 18.00f,
             -13.00f, 0.64f, 20.00f, 22.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "DROVERS' CLOSE",
             32.00f, 38.00f, 30.00f, 0.12f, 39.00f,
             -6.00f, 0.62f, 8.00f, 6.30f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "MILLER'S BEND",
             58.00f, 50.00f, 60.50f, 0.12f, 50.00f,
             6.00f, 0.62f, 8.00f, 6.30f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "CARTWRIGHT YARD",
             42.40f, 55.20f, 40.50f, 0.12f, 53.00f,
             7.00f, 0.62f, 8.00f, 8.40f},
        },
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "FOUNDRY TERRACE",
             82.00f, 34.00f, 74.00f, 0.14f, 24.00f,
             -24.00f, 0.66f, 30.00f, 34.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "COMPANY STORE",
             44.00f, 29.00f, 50.00f, 0.16f, 23.00f,
             -11.00f, 0.66f, 19.00f, 22.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "LOWER SILVERWORKS",
             78.00f, 29.00f, 78.00f, 0.14f, 20.00f,
             -12.00f, 0.64f, 18.00f, 16.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "WORKERS' LANE",
             33.00f, 25.00f, 32.00f, 0.12f, 24.50f,
             6.00f, 0.66f, 12.00f, 9.80f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "FURNACE ALLEY",
             27.00f, 50.00f, 24.00f, 0.12f, 47.50f,
             6.00f, 0.66f, 8.00f, 6.30f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "ORE WAGON YARD",
             42.40f, 55.20f, 39.50f, 0.12f, 52.00f,
             5.00f, 0.66f, 8.00f, 6.50f},
        },
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "CUSTOMS ARCH",
             82.00f, 34.00f, 61.00f, 0.14f, 34.00f,
             -26.00f, 0.64f, 32.00f, 32.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "MARKET CIRCLE",
             44.00f, 29.00f, 46.00f, 0.14f, 34.00f,
             -19.00f, 0.64f, 26.00f, 30.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "ARCHIVE STEPS",
             39.50f, 23.00f, 34.00f, 0.18f, 16.00f,
             -14.00f, 0.64f, 22.00f, 17.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "CLOTH YARD",
             24.00f, 28.00f, 22.00f, 0.14f, 25.00f,
             6.00f, 0.64f, 12.00f, 9.80f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "EXCHANGE DOOR",
             50.00f, 27.25f, 49.50f, 0.14f, 23.50f,
             -6.00f, 0.64f, 8.00f, 6.10f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "COACH COURT",
             42.40f, 55.20f, 38.00f, 0.14f, 54.00f,
             -5.00f, 0.64f, 8.00f, 9.00f},
        },
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "CONTESTED BRIDGE",
             82.00f, 34.00f, 85.00f, 0.16f, 33.00f,
             20.00f, 0.62f, 28.00f, 36.00f},
            {CC_LOCAL_TOWN_SCENE_HEART, "MUSTER SPINE",
             44.00f, 29.00f, 47.00f, 0.16f, 27.00f,
             -11.00f, 0.62f, 20.00f, 19.00f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "ALDERWATCH KEEP",
             78.50f, 27.00f, 78.00f, 0.18f, 20.00f,
             20.00f, 0.60f, 28.00f, 34.00f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "ARMOURERS' ROW",
             33.00f, 25.00f, 34.00f, 0.16f, 24.00f,
             6.00f, 0.62f, 8.00f, 6.30f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "ALDER GATE PASS",
             73.50f, 32.50f, 78.50f, 0.18f, 29.50f,
             0.00f, 0.60f, 9.00f, 6.60f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "LOWER BAILEY",
             42.40f, 55.20f, 39.50f, 0.16f, 52.00f,
             -5.00f, 0.62f, 8.00f, 6.50f},
        },
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "ROSE AVENUE",
             82.0f, 34.0f, 81.0f, 0.18f, 34.0f,
             -13.0f, 0.62f, 18.0f, 8.8f},
            {CC_LOCAL_TOWN_SCENE_HEART, "PETITION SQUARE",
             44.0f, 29.0f, 46.0f, 0.18f, 29.0f,
             9.0f, 0.62f, 11.0f, 7.4f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "CROWN PALACE",
             78.0f, 19.0f, 78.0f, 0.20f, 18.0f,
             -14.0f, 0.60f, 19.0f, 9.6f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "GOLDSMITH COURT",
             33.0f, 25.0f, 36.0f, 0.18f, 24.5f,
             -6.0f, 0.62f, 8.0f, 6.3f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "ROSE CLOISTER",
             58.0f, 50.0f, 64.0f, 0.18f, 47.0f,
             6.0f, 0.62f, 8.0f, 6.5f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "ROYAL COACH YARD",
             42.4f, 55.2f, 39.5f, 0.18f, 52.0f,
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "LANTERN ROAD",
             82.0f, 34.0f, 81.0f, 0.10f, 34.0f,
             -10.0f, 0.66f, 16.0f, 8.4f},
            {CC_LOCAL_TOWN_SCENE_HEART, "EXPEDITION HOLLOW",
             44.0f, 29.0f, 46.0f, 0.10f, 30.0f,
             9.0f, 0.66f, 10.0f, 7.2f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "SEALED DUNGEON ROAD",
             78.0f, 19.0f, 79.0f, 0.12f, 18.0f,
             -12.0f, 0.64f, 18.0f, 9.2f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "SALVAGE ROW",
             34.0f, 38.0f, 33.0f, 0.10f, 38.5f,
             6.0f, 0.66f, 8.0f, 6.3f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "LANTERN GATE",
             29.0f, 51.8f, 28.5f, 0.10f, 49.5f,
             -6.0f, 0.66f, 8.0f, 6.3f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "EXPEDITION WAGON YARD",
             42.4f, 55.2f, 39.5f, 0.10f, 52.0f,
             5.0f, 0.66f, 8.0f, 6.5f},
        },
