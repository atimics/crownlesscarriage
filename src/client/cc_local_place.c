...
static const CcLocalPlaceProfile PLACE_PROFILES[] = {
    {
        ...
        .building = {
            ...
            {"Dairy cottage", 34.00f, 35.50f, 5.20f, 7.20f,
            ...
            {"Orchard bunkhouse", 44.50f, 46.00f, 9.50f, 7.00f,
             5.10f, CC_LOCAL_BUILDING_DOMESTIC, true},
        },
        .compound_structure = {
            ...
            {CC_LOCAL_COMPOUND_WALL, 67.50f, 29.30f, 8.70f, 0.70f, 2.40f},
    ...
    },
    {
        ...
        .compound_structure = {
            ...
            {CC_LOCAL_COMPOUND_WALL, 66.50f, 29.60f, 9.50f, 0.90f, 4.20f},
    ...
    },
    {
        ...
        .building = {
            ...
            {"Money changers", 34.00f, 35.00f, 7.00f, 8.00f,
             5.80f, CC_LOCAL_BUILDING_DOMESTIC, true},
            {"Caravan hostel", 55.00f, 42.00f, 8.00f, 7.00f,
             6.20f, CC_LOCAL_BUILDING_WORKSHOP, true},
            {"Public kitchen", 55.00f, 29.00f, 6.50f, 8.50f,
             5.90f, CC_LOCAL_BUILDING_DOMESTIC, true},
            {"Guild factors", 57.00f, 14.00f, 7.00f, 9.00f,
             6.10f, CC_LOCAL_BUILDING_WORKER_ROW, true},
            {"Mapmakers' row", 32.00f, 47.00f, 8.00f, 7.00f,
             5.80f, CC_LOCAL_BUILDING_WORKSHOP, true},
            {"Eastern exchange", 44.00f, 46.00f, 10.00f, 7.00f,
        ...
        .compound_structure = {
            ...
            {CC_LOCAL_COMPOUND_TOWER, 75.30f, 27.80f, 2.00f, 3.00f, 9.00f},
            {CC_LOCAL_COMPOUND_TOWER, 79.70f, 27.80f, 2.00f, 3.00f, 9.00f},
    ...
    },
    {
        ...
        .compound_structure = {
            ...
            {CC_LOCAL_COMPOUND_TOWER, 75.00f, 27.50f, 2.40f, 3.50f, 11.00f},
            {CC_LOCAL_COMPOUND_TOWER, 79.60f, 27.50f, 2.40f, 3.50f, 11.00f},
    ...
    },
    {
        ...
        .compound_structure = {
            ...
            {CC_LOCAL_COMPOUND_TOWER, 75.00f, 27.50f, 2.40f, 3.00f, 10.50f},
            {CC_LOCAL_COMPOUND_TOWER, 79.60f, 27.50f, 2.40f, 3.00f, 10.50f},
    ...
    },
    {
        ...
        .building = {
            ...
            {"Salvage hall", 20.00f, 34.00f, 11.00f, 7.50f,
             6.60f, CC_LOCAL_BUILDING_WORKSHOP, true},
            {"Chirurgeon's rooms", 34.00f, 35.00f, 5.00f, 7.50f,
             5.80f, CC_LOCAL_BUILDING_DOMESTIC, true},
            {"Warden bunkhouse", 57.00f, 14.00f, 8.00f, 9.50f,
             7.00f, CC_LOCAL_BUILDING_WORKER_ROW, true},
            {"Returned goods shed", 44.00f, 46.00f, 10.00f, 7.00f,
             5.80f, CC_LOCAL_BUILDING_WORKSHOP, true},
        },
        .compound_structure = {
            ...
            {CC_LOCAL_COMPOUND_WALL, 67.00f, 29.70f, 9.00f, 0.80f, 4.60f},
