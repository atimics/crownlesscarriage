...
static const CcLocalPlaceProfile PLACE_PROFILES[] = {
    ...
    },
    {
        ...
        .lane_count = 8,
        .lane = {
            {"Customs road", 5.2f, 6, {{96,34}, {84,34}, {73,34},
                {64,35}, {58,36}, {53,36}}},
            {"Coach court", 4.8f, 7, {{53,36}, {50,38.5f}, {46,39},
                {42,42}, {42,47}, {42,51.2f}, {42,55}}},
            {"Customs rise", 4.2f, 5, {{78.5f,54}, {78.5f,44},
                {78.5f,34}, {78.5f,27}, {78.5f,23}}},
            {"Food lane", 3.0f, 4, {{53,31.5f}, {55,32.5f},
                {58,32.5f}, {61,32}}},
            {"Cloth yard", 3.4f, 5, {{39,31.5f}, {35,29},
                {30,28}, {23,28}, {11,27}}},
            {"Archive lane", 2.8f, 5, {{41,26.5f}, {41,23},
                {41,18}, {41,12}, {35,11}}},
            {"Queen's ring", 3.2f, 9, {{53,31.5f}, {51,26.5f},
                {46,24.5f}, {41,26.5f}, {39,31.5f}, {41,36.5f},
                {46,38.5f}, {51,36.5f}, {53,31.5f}}},
            {"Coach shelter", 3.4f, 3, {{42,51.2f}, {40,51.4f}, {37.4f,51.2f}}},
        },
        .carriage_lane_count = 3,
        .carriage_lane = {{0,5}, {1,5}, {7,2}},
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "MARKET ARRIVAL",
             82.0f, 34.0f, 63.0f, 0.14f, 31.5f,
             -26.0f, 0.64f, 32.0f, 34.0f},
            {CC_LOCAL_TOWN_SCENE_HEART, "QUEEN'S MARKET",
             44.0f, 29.0f, 46.0f, 0.14f, 31.5f,
             -18.0f, 0.64f, 24.0f, 23.0f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "CUSTOMS KEEP",
             78.0f, 19.0f, 78.0f, 0.16f, 19.0f,
             -11.0f, 0.62f, 18.0f, 9.2f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "ARCADE CLOSE",
             50.0f, 27.25f, 49.5f, 0.14f, 23.5f,
             -6.0f, 0.64f, 8.0f, 6.1f},
        ...
        .building = {
            {"West hostel", 20.00f, 15.00f, 8.00f, 10.00f,
             5.20f, CC_LOCAL_BUILDING_DOMESTIC, true},
            {"Archive and mapmakers", 32.00f, 14.00f, 7.00f, 9.00f,
             5.60f, CC_LOCAL_BUILDING_WORKSHOP, true},
    ...
    },
    {
        ...
        .scene = {
            {CC_LOCAL_TOWN_SCENE_ARRIVAL, "CONTESTED BRIDGE",
             82.0f, 34.0f, 81.0f, 0.16f, 34.0f,
             11.0f, 0.62f, 16.0f, 8.6f},
            {CC_LOCAL_TOWN_SCENE_HEART, "MUSTER SPINE",
             44.0f, 29.0f, 46.0f, 0.16f, 29.5f,
             -9.0f, 0.62f, 11.0f, 7.2f},
            {CC_LOCAL_TOWN_SCENE_LANDMARK, "ALDERWATCH KEEP",
             78.0f, 19.0f, 78.0f, 0.18f, 19.0f,
             12.0f, 0.60f, 17.0f, 9.4f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_FIRST, "ARMOURERS' ROW",
             33.0f, 25.0f, 34.0f, 0.16f, 24.0f,
             6.0f, 0.62f, 8.0f, 6.3f},
            {CC_LOCAL_TOWN_SCENE_CLOSE_SECOND, "ALDER GATE PASS",
             73.5f, 32.5f, 78.5f, 0.18f, 29.5f,
             0.0f, 0.60f, 9.0f, 6.6f},
            {CC_LOCAL_TOWN_SCENE_CARRIAGE_YARD, "SUPPLY WAGON YARD",
             42.4f, 55.2f, 39.5f, 0.16f, 52.0f,
             -5.0f, 0.62f, 8.0f, 6.5f},
        },
