                                       ...
                                       char *error, size_t error_capacity)
{
    ...
    if ((legacy_version == 38U || legacy_version == 39U ||
         ...
         legacy_version == 70U || legacy_version == 71U || legacy_version == 72U || legacy_version == 73U || legacy_version == 74U || legacy_version == 75U || legacy_version == 76U || legacy_version == 77U || legacy_version == 78U || legacy_version == 79U || legacy_version == 80U || legacy_version == 81U || legacy_version == 82U || legacy_version == 83U) &&
