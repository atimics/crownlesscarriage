                                       ...
                                       char *error, size_t error_capacity)
{
    ...
    if ((legacy_version == 38U || legacy_version == 39U ||
         ...
         legacy_version == 77U || legacy_version == 78U || legacy_version == 79U || legacy_version == 80U || legacy_version == 81U || legacy_version == 82U || legacy_version == 83U || legacy_version == 84U || legacy_version == 85U || legacy_version == 86U || legacy_version == 87U || legacy_version == 88U) &&        sim->generator_version == 25U) {        /* Schema 47 adds bandit war camps (camp_settlement_id, default
