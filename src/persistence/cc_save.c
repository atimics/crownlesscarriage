...
static bool CreateSchema(sqlite3 *database, char *error, size_t error_capacity)
{
    ...
    return Execute(database, "CREATE TABLE IF NOT EXISTS archive_recruitment_training (id INTEGER PRIMARY KEY CHECK(id=1),labor_days INTEGER NOT NULL,trainer_labor_days INTEGER NOT NULL,last_work_day INTEGER NOT NULL,wages_paid INTEGER NOT NULL,archive_training_week INTEGER NOT NULL);", error, error_capacity) &&
                                 ...
                                 char *error, size_t error_capacity)
{
    ...
    return Execute(database,
            ...
            "DELETE FROM town_recovery; DELETE FROM grain_supply; DELETE FROM archive_recruitment; DELETE FROM archive_recruitment_journey; DELETE FROM archive_recruitment_training;"
