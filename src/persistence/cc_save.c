                           ...
                           char *error, size_t error_capacity)
{
    ...
    for (int32_t i = 0; i < sim->character_count; ++i) {
        ...
        BindId(character_statement, column++, sim->schema_version >= 78U ? character->travel_destination_id : 0U);
        BindInt(character_statement, column++, sim->schema_version >= 78U ? character->travel_arrival_day : 0);
