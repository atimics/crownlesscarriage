...
EXPECTED_HASHES = {
    ...
    # Schema 122 adds the company's last view of each town (The Return).
    122: {
        1: "11206720155036087240",
        2: "13195177453980265820",
        3: "4331488811583093698",
    },
    # Schema 123 adds the news the company meets on the road (The Return M4).
    123: {
        1: "1707834497035237311",
        2: "7154813422435928097",
        3: "10003514435961517809",
    },
}
