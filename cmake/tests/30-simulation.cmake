...
if(NOT EMSCRIPTEN)
    add_executable(road_position_runtime_tests
        tests/road_position_runtime_tests.c)
    target_link_libraries(road_position_runtime_tests PRIVATE
        crownless_persistence crownless_coop)
    cc_strict_warnings(road_position_runtime_tests)
    cc_large_sim_stack(road_position_runtime_tests)
    add_test(NAME saved_road_position_runtime
             COMMAND road_position_runtime_tests)
endif()
